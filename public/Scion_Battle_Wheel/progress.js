...
var text_color = "gray"; // the color of the percentage text (50%)
...
function setup_bar()
{
	...
	if (window.innerHeight) { // All but IE
		bartop = window.innerHeight / 3;
		barleft = (window.innerWidth - window_width) / 2;
	}
	//else if (document.documentElement.clientHeight) { // IE
	else {
		bartop = screen.height / 3;
		barleft = (screen.width - window_width) / 2;
	}
